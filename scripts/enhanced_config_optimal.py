...
KEYWORDS_CONFIG: Dict[str, list[str]] = {
    ...
    "medium_impact": [
        ...
        "oil surge", "gas spike", "gold rally", "bitcoin surge", "crypto rally",
        "tech earnings", "biotech breakthrough", "vaccine news", "clinical trial",
        "supply chain", "semiconductor shortage", "chip demand", "ev sales",
        "renewable energy", "carbon credit", "esg mandate", "sustainability",
        "forex intervention", "currency devaluation", "pension reform",
        "regulatory approval", "patent expiry", "antitrust probe",
    ],
    "low_impact": [
        ...
        "milestone", "beta", "update", "patch", "feature", "demo",
        "pilot program", "trial", "experiment", "test", "assessment",
        "survey", "poll", "interview", "podcast", "blog post", "article",
        "commentary", "opinion", "review", "rating", "ranking", "list",
        "guide", "tutorial", "workshop", "training", "certification",
        "recruitment", "hiring", "promotion", "retirement", "resignation",
        "relocation", "expansion", "opening", "closing", "renovation",
        "upgrade", "maintenance", "routine", "scheduled", "planned",
        "expected", "anticipated", "preliminary", "initial", "draft",
        "proposal", "suggestion", "recommendation", "consideration",
        "discussion", "debate", "consultation", "feedback", "comment",
        "response", "reply", "statement", "clarification", "correction",
        "update", "revision", "amendment", "modification", "adjustment",
