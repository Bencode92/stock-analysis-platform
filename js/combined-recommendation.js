...
const legalStatuses = {
    "MICRO": {
        // Placez ici le premier objet
        id: 'micro-entreprise',
        name: "Micro-entreprise",
        shortName: "Micro-entreprise",
        /* ...tous les détails du statut micro-entreprise... */
    },
    /* 
    AJOUTEZ ICI TOUS LES AUTRES STATUTS JURIDIQUES
    "EI": { ... },
    "EURL": { ... },
    ...etc
    */
...
const exclusionFilters = [
    /* AJOUTEZ ICI LES FILTRES D'EXCLUSION */
];
window.exclusionFilters = exclusionFilters;

const ratingScales = {
    /* AJOUTEZ ICI LES ÉCHELLES DE NOTATION */
};
